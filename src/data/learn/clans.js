...
export const clansData = [
  ...
  { misingName: 'Pa:nyang', legalSpelling: 'Panyang', ipa: '/paɲaŋ/', voice: '/audio/clans/panyang.ogg' },
  ...
  { misingName: 'Médok', legalSpelling: 'Medok', ipa: '/mədɔɡ/', voice: '/audio/clans/medok.ogg' },
  ...
  { misingName: 'Ngate', legalSpelling: 'Ngate, Natey', ipa: '/ŋate/', voice: '/audio/clans/ngate.ogg' },
  ...
  { misingName: 'Koptak', legalSpelling: 'Koptak', ipa: '/kɔptaɡ/', voice: '/audio/clans/koptak.ogg' },
